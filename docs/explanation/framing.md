...
//
using packet = rbe::frame::dsrl_type<
  UnitHeader, // Packet header
  rbe::many::dsrl_type< // Packet payload: a sequence of messages, each with its own header
    rbe::frame::dsrl_type<
      MsgHeader, // Message header
      rbe::any::dsrl_type<AddOrder, ReduceSize, Trade> // Message payload: one of the candidate types
    >
  >
>;
