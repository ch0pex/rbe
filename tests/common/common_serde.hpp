...
constexpr TestCase message_with_array_be_test {
      ...
      MessageWithArrayBe {
        .header =
            CommonHeader {
              ...
              .size      = 100,
              .type      = 6,
              .timestamp = 0x1234567890ABCDEFULL,
            },
        .traderID = 789,
        .senderID =
  ...
  .wire = bytes(
      0x00, 0x00, 0x00, 0x03, // version (big-endian)
      0x00, 0x64, // size (big-endian)
      0x00, 0x06, // type (big-endian)
      0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF, // timestamp (big-endian)
      0x03, 0x15, // traderID (big-endian)
